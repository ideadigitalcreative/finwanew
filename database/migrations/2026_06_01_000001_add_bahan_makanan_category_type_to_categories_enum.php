...
{
    /**
     * Adds 'pengeluaran_bahan_makanan' to the categories type ENUM.
     *
     * Kategori baru: Bahan Makanan & Bumbu Dapur 🍜
     * Untuk mencatat pembelian bahan masak, bumbu, mie instan, dll.
     */
