...
{
    /**
     * Adds 'pengeluaran_gaya_hidup' to the categories type ENUM.
     *
     * Kategori baru: Gaya Hidup 🌟
     * Untuk mencatat rokok, vape, minuman energi, dan pengeluaran gaya hidup lainnya.
     */
