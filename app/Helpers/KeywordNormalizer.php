...
class KeywordNormalizer
{
    ...
    public static function normalize(string $input): string
    {
        ...
        $mappings = [
            // Cashflow / Balance queries
            'cek saldo' => 'cek cashflow',
            'lihat saldo' => 'cek cashflow',
            'saldo saya' => 'cek cashflow',
            'total saldo' => 'cek cashflow',
            'cek uang' => 'cek cashflow',
            'lihat uang' => 'cek cashflow',
