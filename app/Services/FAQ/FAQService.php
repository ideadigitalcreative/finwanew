...
class FAQService
{
    ...
    public function checkAndHandleFAQ(string $messageText): bool
    {
        ...
        $faqPatterns = [
            ...
            [
                'patterns' => [
                    'bagaimana cara', 'gimana cara', 'cara pakai', 'cara menggunakan', 'cara gunakan',
                    'tutorial', 'panduan', 'petunjuk', 'how to use', 'cara kerja', 'gimana sih',
                    'caranya gimana', 'bagaimana caranya', 'gimana caranya', 'cara pakenya',
                    'mulai dari mana', 'harus gimana', 'langkah-langkah', 'step by step'
                ],
            ...
            [
                'patterns' => [
                    'apa itu finwa', 'apa itu aplikasi', 'finwa itu apa', 'tentang finwa',
                    'tentang aplikasi', 'about finwa', 'what is finwa', 'finwa apaan',
                    'ini apaan', 'ini apa', 'kamu siapa', 'siapa kamu', 'apakah finwa',
                    'finwa adalah', 'kegunaan finwa'
                ],
            ...
            [
                'patterns' => [
                    'cara buat dompet', 'cara tambah dompet', 'cara bikin dompet',
                    'gimana buat dompet', 'gimana tambah dompet', 'bagaimana buat dompet',
                    'bagaimana tambah dompet', 'cara tambah rekening', 'cara buat rekening',
                    'tambah wallet gimana', 'buat wallet gimana', 'cara add wallet',
                    'cara menambah dompet', 'cara membuat dompet', 'cara nambah dompet',
                    'dompet baru gimana', 'rekening baru gimana', 'mau buat dompet',
                    'pengen buat dompet', 'caranya buat dompet'
                ],
            ...
            [
                'patterns' => [
                    'cara buat budget', 'cara budgeting', 'cara set budget', 'cara atur budget',
                    'gimana budgeting', 'gimana set budget', 'gimana buat budget',
                    'bagaimana budgeting', 'bagaimana buat budget', 'bagaimana set budget',
                    'cara buat anggaran', 'cara atur anggaran', 'gimana atur anggaran',
                    'budget gimana', 'anggaran gimana', 'cara pakai budget', 'cara menggunakan budget',
                    'mau budgeting', 'pengen budgeting', 'caranya budgeting', 'caranya set budget'
                ],
            ...
            [
                'patterns' => [
                    'tips keuangan', 'tips nabung', 'tips hemat', 'tips menabung', 'tips menghemat',
                    'gimana cara nabung', 'gimana cara hemat', 'cara nabung', 'cara hemat',
                    'saran keuangan', 'saran nabung', 'saran hemat', 'advice keuangan',
                    'tips uang', 'tips kelola uang', 'tips kelola keuangan', 'tips finansial',
                    'biar gak boros', 'supaya hemat', 'agar hemat', 'cara mengelola uang',
                    'cara mengelola keuangan', 'cara atur keuangan', 'cara atur uang',
                    'kasih tips', 'minta tips', 'ada tips', 'bagikan tips',
                    'tips buat saya', 'caranya supaya hemat', 'cara biar hemat'
                ],
                'answer' => $this->getFAQFinancialTips(),
            ],
            // ========== FITUR GRUP ==========
            [
                'patterns' => [
                    'bisa untuk grup', 'untuk grup', 'bisa di grup', 'pakai di grup',
                    'group chat', 'grup wa', 'grup whatsapp', 'bisa grup'
                ],
            ...
            [
                'patterns' => [
                    'berapa harga', 'berapa biaya', 'tarif', 'pricing', 'biaya langganan',
                    'harga langganan', 'bayar berapa', 'gratis', 'free', 'berbayar',
                    'harganya berapa', 'biayanya berapa'
                ],
            ...
            [
                'patterns' => [
                    'aman', 'keamanan', 'privasi', 'privacy', 'data aman', 'data saya',
                    'security', 'rahasia', 'data bocor', 'data aman gak'
                ],
            ...
            [
                'patterns' => [
                    'fitur apa saja', 'bisa apa saja', 'apa saja fitur', 'fitur yang tersedia',
                    'kemampuan', 'features', 'bisa ngapain', 'bisa apa aja'
                ],
            ...
            [
                'patterns' => [
                    'cara daftar', 'gimana daftar', 'register', 'registrasi', 'buat akun',
                    'sign up', 'signup', 'daftar gimana', 'caranya daftar'
                ],
            ...
            [
                'patterns' => [
                    'hubungi', 'contact', 'kontak', 'customer service', 'cs', 'support',
                    'bantuan', 'komplain', 'lapor masalah'
                ],
            ...
            [
                'patterns' => [
                    'kategori apa saja', 'jenis kategori', 'daftar kategori',
                    'macam kategori', 'kategori yang tersedia', 'kategori apa aja'
                ],
            ...
            [
                'patterns' => [
                    'cara export', 'download laporan', 'cetak laporan', 'print laporan',
                    'buat laporan', 'export gimana', 'unduh laporan'
                ],
            ...
            [
                'patterns' => [
                    'ada limit', 'batasan', 'maksimal transaksi', 'limit transaksi', 'batas'
                ],
            ...
            [
                'patterns' => [
                    'cara catat transaksi', 'cara input transaksi', 'cara masukin transaksi',
                    'gimana catat', 'gimana input', 'cara catat pengeluaran',
                    'cara catat pemasukan', 'cara input pengeluaran', 'cara input pemasukan',
                    'caranya catat', 'caranya input'
                ],
            ...
            [
                'patterns' => [
                    'cara cek saldo', 'gimana cek saldo', 'bagaimana cek saldo',
                    'cara lihat saldo', 'gimana lihat saldo', 'caranya cek saldo'
                ],
    ...
    public function getFAQPricing(): string
    {
        return "💰 *Harga & Paket FinWa*\n\n" .
            ...
            "Coba semua fitur premium tanpa biaya!\n\n" .
            "*💎 Paket Premium*\n" .
            ...
            "📱 *Daftar sekarang:*\n" .
            "https://finwa.web.id/checkout?plan=free\n\n" .
            "💡 Mulai trial gratis 3 hari, tanpa kartu kredit!";
    }
    ...
    public function getFAQRegister(): string
    {
        return "📝 *Cara Daftar FinWa*\n\n" .
            ...
            "🎁 *Bonus:* Trial gratis 30 hari untuk semua fitur premium!";
    }
    ...
    {
        return "📝 *Cara Mencatat Transaksi*\n\n" .
            "*💸 Catat Pengeluaran:*\n" .
            "Cukup chat seperti biasa!\n\n" .
            "*Contoh:*\n" .
            "• _makan siang 25rb_\n" .
            "• _beli bensin 50k_\n" .
            "• _grab ke kantor 15rb_\n" .
            "• _kopi starbucks 45.000_\n\n" .
            "*💰 Catat Pemasukan:*\n" .
