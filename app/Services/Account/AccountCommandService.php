    ...
    public function handleResetAccount(string $messageText): void
    {
        try {
            ...
            $isConfirmed = str_contains($textLower, 'konfirmasi reset') || 
                           ...
                           str_contains($textLower, 'ya reset') ||
                           str_contains($textLower, 'lanjut reset') ||
                           str_contains($textLower, 'reset sekarang') ||
                           str_contains($textLower, 'oke reset');
            ...
            if (!$isConfirmed) {
                ...
                $this->sendReply(
                    ...
                    "*KONFIRMASI RESET* atau *RESET SEKARANG*\n\n" .
